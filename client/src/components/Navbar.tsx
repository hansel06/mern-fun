...
const Navbar = () => {
  ...
  return (
    <nav className="sticky top-0 z-50 bg-surface-elevated border-b border-border shadow-sm transition-colors duration-300">
      ...
      {/* Mobile Menu */}
      {isMenuOpen && (
        <div className="md:hidden bg-surface-elevated border-b border-border absolute w-full transition-colors duration-300">
